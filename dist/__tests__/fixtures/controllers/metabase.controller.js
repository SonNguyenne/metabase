...
let MetabaseController = class MetabaseController {
    constructor(mbService, // @inject('services.MetabaseService') public mbService: MetabaseService,
    metabaseUrl) {
    ...
    async dashboard() {
        ...
        const response = await axios_1.default.get(`${this.metabaseUrl}/dashboard`, {
            headers: {
...
MetabaseController = tslib_1.__decorate([
    ...
    tslib_1.__param(1, (0, core_1.inject)(keys_1.MetabaseServiceBindings.METABASE_URL)),
    tslib_1.__metadata("design:paramtypes", [metabase_service_1.MetabaseService, String])
], MetabaseController);
